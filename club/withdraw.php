...
if($amount >= $balance){
    ...
    $final_amount = $balance-$_POST['withdraw_amount'];
	...
	$statement->execute(array($by,$_POST['withdraw_amount'],$_POST['withdraw_method'],$_POST['withdraw_to'],$_POST['account_type'],$date,$a));
