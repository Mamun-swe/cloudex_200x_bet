...
if(isset($_POST['form1'])) {
	...
	if($_SESSION['admin']['role'] == 'Super Admin') {
	    ...
	    if($valid == 1) {
			...
			$statement->execute(array($_POST['full_name'],$_POST['email'],$_POST['phone'],$_SESSION['admin']['id']));
		...
		$statement->execute(array($_POST['phone'],$_SESSION['admin']['id']));
...
if(isset($_POST['form3'])) {
    ...
    if($valid == 1) {
		...
		$statement->execute(array(md5($_POST['password']),$_SESSION['admin']['id']));
